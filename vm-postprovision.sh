...
echo "locked/agent.name="icp-mcs-001"" >> agent.props
...
echo  if [ 0 -eq 0 ] >> /opt/ibm-ucd/agent/auto.sh
...
(crontab -l; echo */1 vm-postprovision.sh vm-postprovision.sh vm-postprovision.sh vm-postprovision.sh /opt/ibm-ucd/agent/auto.sh) | crontab - && crontab -l
